...
public class Repo extends BaseTimeEntity {
	...
	@Builder
	public Repo(Portfolio portfolio, RepoGroup repoGroup, String rpName, String rpShortContents, String rpReadme,
		Long rpStar, LocalDate rpSdate, LocalDate rpEdate, String rpRole, String rpLongContents) {
	...
	public void update(String rpName, String rpShortContents, String rpReadme, Long rpStar, LocalDate rpSdate,
		LocalDate rpEdate, String rpRole, String rpLongContents, RepoGroup repoGroup) {
		this.rpName = rpName;
		this.rpShortContents = rpShortContents;
		this.rpReadme = rpReadme;
		this.rpStar = rpStar;
